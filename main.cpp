    ...
    while (run){
        ...
        if(a == "1"){
            ...
            while(go){
                ...
                getline(cin,answer);
                if(answer == "the alphabet" or answer == "The Alphabet" or answer == "Alphabet" or answer == "alphabet" or answer == "The alphabet"){
            ...
            Game g;
            g.addRoom("A","Poor people have it, rich people need it, and if you eat it you die. What is it?","nothing","Nothing","it's nothing");
            g.addRoom("B", "Paul is six feet tall, works at a butcher's shop, and wears size 9 shoes. What  does he weigh?","Meat","meat","he weights meat");
            g.addRoom("C","What has many keys but cannot open a single door?","computer","piano","Piano");
            g.addRoom("D","What relation would your father's sister's sister-in-law be to you?","mother","your mother","my mother");;
            g.addRoom("E","No sooner spoken than broken. What is it?","silence","the silence","Silence");
            g.addRoom("F","What is it that you ought to keep after giving it to someone else?","my word","your word","a promise");
            g.addRoom("G","What English word becomes shorter when it is lengthened?","short","Short","it's short");
            g.addRoom("H","I happen once in a day, twice in a decade, but never in a lifetime. What am I?","the letter d","letter d","d");
            g.addRoom("I","David's father has three sons: Snap, Crackle, and who?","David","david","David, of course");
            g.addHallway("A","B");
            g.addHallway("A","I");
            g.addHallway("A","E");
            g.addHallway("B","C");
